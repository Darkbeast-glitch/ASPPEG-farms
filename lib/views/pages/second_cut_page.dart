...
class SecondCutPage extends ConsumerStatefulWidget {
  const SecondCutPage({super.key});

  @override
  _SecondCutPageState createState() => _SecondCutPageState();
}

class _SecondCutPageState extends ConsumerState<SecondCutPage> {
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Gap(4),
                      Text(
                        "Record the details of your second cut for tracking and analysis.",
...
FadeInUp(
 ...
 Future<void> _handleSecondCutSubmission() async {
  ...
  try {
    ...
    final success = await apiService.addSecondCutRecord(cutData);
